    ...
    public function getMenu(Request $request){
        ...
        foreach($trans as $tran){
            ...
            foreach($menus as $menu){
                ...
                //         <div>
                //             <h1 class="whitespace-nowrap max-w-xs overflow-hidden">&nbsp;&nbsp;'.$menu->quantity.'x&nbsp;&nbsp;&nbsp;<span>'.$menu->name.'</span>&nbsp;&nbsp;</h1>
                //         </div>
                //         <div class="mr-5">
            ...
            //         <span class="relative text-gray-500 font-bold text-xl border border-gray-500 px-4 py-2 w-auto ml-10 bg-white z-50 rounded"></span>
            //         <div class="relative -top-[13px] border border-gray-500 z-10 w-full pt-6 pl-2 text-xl font-semibold text-gray-500 tracking-wide rounded-lg">'.$m.'</div>
            //     </div>
            // ';
        }
