            ...
            <div class="bg-white shadow-md rounded-lg p-3 w-full">
                <div class="flex justify-end flex-row lg:justify-between mb-3">
                    ...
                    <div class="justify-self-end flex items-center">
                        <label for="countries" class="block text-sm font-medium text-gray-900 mr-4">Timeframe: </label>
                        <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full sm:w-80 p-2.5">
